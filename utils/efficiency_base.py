...
def run_test(ofile="aic2020-base.json"):
    odir = os.path.join(os.path.dirname(__file__), '../experiments/efficiency')
...
""")
    ...
    if return_code != 0 or not os.path.exists(ofile):
        eprint(
            "An error was encountered and the performance evaluation did not complete successfully.")
...
if __name__ == '__main__':
    print("AIC2020 Efficiency Base Factor: %f" %
          compare_results(aggregate_results(run_test())))
